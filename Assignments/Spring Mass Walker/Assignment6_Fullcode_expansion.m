...
saveas(figure1, 'position_vs_time2.png'); % Save the figure as PNG
...
saveas(figure2, 'vertical_position_vs_velocity2.png'); % Save the figure as PNG
...
saveas(figure3, 'vertical_forces_vs_time2.png'); % Save the figure as PNG
...
saveas(figure4, 'horizontal_forces_vs_time2.png'); % Save the figure as PNG
