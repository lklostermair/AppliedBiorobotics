...
[broad_results, globalBest] = runPSO(broad_max_iterations, broad_swarm_size, broad_w, broad_c1, broad_c2, VarMin, VarMax, false);
duration_broad=toc;
...
tic;
[bloodhound_results, globalBest] = runPSO(bloodhound_c1_max_iterations, bloodhound_c1_swarm_size, bloodhound_c1_w, bloodhound_c1_c1, bloodhound_c1_c2, adjusted_VarMin, adjusted_VarMax, true); % With velocity limit
duration_bloodhound=toc;
writetable(broad_results, 'broad.csv');
writetable(bloodhound_results, 'bloodhound.csv');
...
function [broad_results, globalBest] = runPSO(max_iterations, swarm_size, w, c1, c2, VarMin, VarMax, MaxVelOn)
